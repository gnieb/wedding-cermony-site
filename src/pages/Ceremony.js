export default function Ceremony () {
    return(
        <div>
            ...
            {/* Event Timeline */}
            <div>
                <div className="p-10 text-justify flex pt-10 font-bold text-2xl w-full justify-center">Please enjoy the ceremony with us - we really want to see your faces, not your devices! 
                    As we tie the knot, please be our guest. Our photographer will take care of the rest!</div>
